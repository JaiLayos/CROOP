...
public class SignUp_COOP_Activity_4 extends AppCompatActivity {
    ...
    private void initializeComponents() {
        ...
        next.setOnClickListener(view -> {
            ...
            if(coopMobile.isEmpty() || !phoneNumberValidation(coopMobile)){
                ...
                submitToFirebase(coopMobile, coopEmail);
            }
        });
    }
    ...
    public void submitToFirebase(String coopMobile, String coopEmail){
        ...
        groupSellerProfile.put("Bio", groupSellers.getBio());
        ...
        CollectionReference groupSellerRef = db.collection("Farming Cooperatives");
