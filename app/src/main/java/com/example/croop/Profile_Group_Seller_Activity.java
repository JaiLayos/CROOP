...
public class Profile_Group_Seller_Activity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.profile_group_seller);
    ...
    private void initializeComponents(String collection) {
        ...
        userGroup = findViewById(R.id.userGroupText);
