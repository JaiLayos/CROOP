...
public class Activity_Orders_Individual extends AppCompatActivity {
    ...
    private void getGroupOrdersBySellerID(int id) {
        ...
        call.enqueue(new Callback<List<SellerOrdersDTO>>() {
            ...
            public void onFailure(Call<List<SellerOrdersDTO>> call, Throwable t) {
                Toast.makeText(Activity_Orders_Individual.this, "API_ERROR"+ t.toString(), Toast.LENGTH_SHORT).show();
                t.printStackTrace();
            }
        });
    }
