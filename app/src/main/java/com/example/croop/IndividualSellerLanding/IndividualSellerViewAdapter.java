...
public class IndividualSellerViewAdapter extends FragmentStateAdapter {
    private static final String TAG = "MyViewAdapter";
    public IndividualSellerViewAdapter(FragmentActivity fragmentActivity) {
    ...
    public Fragment createFragment(int position) {
        switch (position) {
            ...
            case 2:
                return new Fragment_Notification_Individual_Seller();
            default:
