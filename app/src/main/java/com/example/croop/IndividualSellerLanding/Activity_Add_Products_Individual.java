            ...
            public void onResponse(Call<IndividualSellersProductsInventory> call, Response<IndividualSellersProductsInventory> response) {
                ...
                db.collection("Product Tags")
                        ...
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(Activity_Add_Products_Individual.this, "Tags saved successfully!", Toast.LENGTH_SHORT).show();
                        })
                        .addOnFailureListener(e -> {
                            Toast.makeText(Activity_Add_Products_Individual.this, "Error saving tags: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        });
