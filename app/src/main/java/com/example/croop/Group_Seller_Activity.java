...
public class Group_Seller_Activity extends AppCompatActivity {
    ...
    private void initializeComponent() {
        ...
        coop.setOnClickListener(view -> {
            ...
            String cr = currentUsage.getCurrentUsage();
            switch (cr){
                case "Sign In":
                    ...
                    break;
                case "Sign Up":
                    Intent intent_1 = new Intent(this, SignUp_COOP_Activity.class);
        ...
        assoc.setOnClickListener(view -> {
            ...
            switch(cr){
                case "Sign In":
                    ...
                    break;
                case "Sign Up":
                    Intent intent_1 = new Intent(this, SignUp_Farm_Assoc_Activity.class);
                    startActivity(intent_1);
                    break;
            }
