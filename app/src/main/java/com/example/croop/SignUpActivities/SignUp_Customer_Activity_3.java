...
public class SignUp_Customer_Activity_3 extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        signInHyperlink.setOnClickListener(view -> {
            Intent intent = new Intent(SignUp_Customer_Activity_3.this, SignIn_Activity.class);
    ...
    private void initializeComponents() {
        ...
        next.setOnClickListener(view -> {
            ...
            if(password.matches(rePassword)){
                ...
                Intent intent = new Intent(this, SignUp_Customer_Activity_4.class);
                startActivity(intent);
            }else{
