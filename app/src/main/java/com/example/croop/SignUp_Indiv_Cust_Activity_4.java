    ...
    private void initializeComponent() {
        ...
        nextButton.setOnClickListener(view ->{
            ...
            if(!phoneNumberValidation(phone_customer)){
                ...
                sendToFirebase(phone_customer, email_customer);
            }
        });
    }

    private void sendToFirebase(String phone_customer, String email_customer) {
        ...
        customerRef.add(customerProfile).addOnSuccessListener(documentReference -> {
            Toast.makeText(SignUp_Indiv_Cust_Activity_4.this, "Customer added!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(SignUp_Indiv_Cust_Activity_4.this, SignUp_MobPhone_valid.class);
            startActivity(intent);
        }).addOnFailureListener(e ->{
            Toast.makeText(SignUp_Indiv_Cust_Activity_4.this, "Error!", Toast.LENGTH_SHORT).show();
        });
