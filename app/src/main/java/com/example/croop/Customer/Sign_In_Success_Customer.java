...
public class Sign_In_Success_Customer extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.header_customer_home);  // This will load the correct XML layout
        ...
        IndividualCustomerViewAdapter adapter = new IndividualCustomerViewAdapter(this);  // Updated to use the correct adapter
